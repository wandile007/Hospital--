...
namespace Health__.Controllers
{
    public class DoctorSchedulesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ScheduleId,DoctorId,ScheduleDate,StartTime,EndTime,IsAvailable,IsRecurring,RecurrencePattern,Notes,CreatedOn")] DoctorSchedule doctorSchedule)
        {
            ...
            ViewBag.DoctorId = new SelectList(db.Doctors, "DoctorId", "Name", doctorSchedule.DoctorId);
            return View(doctorSchedule);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ScheduleId,DoctorId,ScheduleDate,StartTime,EndTime,IsAvailable,IsRecurring,RecurrencePattern,Notes,CreatedOn")] DoctorSchedule doctorSchedule)
        {
            if (ModelState.IsValid)
            {
